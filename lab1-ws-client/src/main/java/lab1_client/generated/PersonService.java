 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://lab1_ws_j2ee/", wsdlLocation = "http://localhost:8080/lab1_ws_j2ee_war_exploded/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://lab1_ws_j2ee/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/lab1_ws_j2ee_war_exploded/PersonService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://lab1_ws_j2ee/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1_ws_j2ee/", "PersonWebServicePort"), PersonWebService.class, features);
    }
